package reading.designPatternLesson.creational.prototype;

import reading.designPatternLesson.creational.prototype.deepClone.Address;
import reading.designPatternLesson.creational.prototype.deepClone.Customer;
...
public class PrototypeTest {
    ...
    public void whenPrototypeCloneSuccess() {
        ...
        //通过浅克隆实现
        final reading.designPatternLesson.creational.prototype.shallowClone.Customer
                shallowCustomer = new reading.designPatternLesson.creational.prototype.shallowClone.Customer();
        shallowCustomer.setAddress(new reading.designPatternLesson.creational.prototype.shallowClone.Address());
        final reading.designPatternLesson.creational.prototype.shallowClone.Customer
